...
<h2>Labels: Character Clip</h2>
<span id="author">Written by: <a href="mailto:examples@c4ios.com">Travis Kirton</a></span>
</div>

<div class="span3 offset1 calls">
<a href="https://gist.github.com/3239859" title="Get the code from Github"><button class="btn-download"><span>{ }</span></button></a>
</div>
</div>
...
<div class="paragraph"><p>There are several line break modes that you can specify for a label, here we show you how to work with <em>character clipping</em>.</p></div>
<div class="imageblock">
<div class="content">
<img src="labelCharacterClip/labelCharacterClip.png" alt="Label Character Clip" height="500" />
</div>
</div>
</div>
</div>
...
<div class="sect1">
<h2 id="_character_clip">2. Character Clip</h2>
<div class="sectionbody">
<div class="paragraph"><p>Applying the <tt>LABELCHARCLIP</tt> property will clip the end of a label&#8217;s text to its frame. This results in a label that does not have an ellipsis "&#8230;" at the end if its text is too long for the frame.</p></div>
<div class="listingblock">
<div class="content"><div class="highlight"><pre><span class="n">label</span><span class="py">.lineBreakMode</span> <span class="o">=</span> <span class="n">LABELCHARCLIP</span><span class="p">;</span>
</pre></div></div></div>
</div>
</div>
  </div>
