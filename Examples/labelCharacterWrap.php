...
<h2>Labels: Character Wrap</h2>
<span id="author">Written by: <a href="mailto:examples@c4ios.com">Travis Kirton</a></span>
</div>

<div class="span3 offset1 calls">
<a href="https://gist.github.com/3239843" title="Get the code from Github"><button class="btn-download"><span>{ }</span></button></a>
</div>
</div>
...
<div class="paragraph"><p>There are several line break modes that you can specify for a label, here we show you how to work with <em>character wrapping</em>.</p></div>
<div class="imageblock">
<div class="content">
<img src="labelCharacterWrap/labelCharacterWrap.png" alt="Label Character Wrap" height="500" />
</div>
</div>
</div>
</div>
...
<div class="sect1">
<h2 id="_character_wrap">2. Character Wrap</h2>
<div class="sectionbody">
<div class="paragraph"><p>Applying the <tt>LABELCHARWRAP</tt> property will cause the label to break its words at individual characters without preserving the readability of the text&#8230; It won&#8217;t truncate words or text to make a better fit.</p></div>
<div class="listingblock">
<div class="content"><div class="highlight"><pre><span class="n">label</span><span class="py">.lineBreakMode</span> <span class="o">=</span> <span class="n">LABELCHARWRAP</span><span class="p">;</span>
</pre></div></div></div>
</div>
</div>
  </div>
