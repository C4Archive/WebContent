...
<div class="paragraph"><p>We can create a label for each font family name and add this to the canvas of our application.</p></div>
<div class="imageblock">
<div class="content">
<img src="fontFamilyLabels/fontFamilyLabels.png" alt="Font Family Labels" height="500" />
</div>
</div>
...
<td class="content">
<div class="title">Online List</div><a href="www.iosfonts.com">iOS Fonts</a> has a complete list of fonts for iOS, and shows their availability (i.e. iOS 4.3, 5.0, 6.0, etc&#8230;)</td>
</tr></table>
</div>
</div>
</div>
...
<div class="sect2">
<h3 id="_a_tricky_for_loop">2.2. A Tricky for Loop</h3>
<div class="paragraph"><p>We create a loop that does a couple of things:</p></div>
<div class="ulist"><ul>
<li>
<p>
...
<div class="listingblock">
<div class="content"><div class="highlight"><pre><span class="k">for</span><span class="p">(</span><span class="nc">NSString</span> <span class="o">*</span><span class="n">familyName</span> <span class="k">in</span> <span class="n">familyNames</span><span class="p">)</span> <span class="p">{</span>
    <span class="n-ProjectClass">C4Font</span> <span class="o">*</span><span class="n">f</span> <span class="o">=</span> <span class="p">[</span><span class="n-ProjectClass">C4Font</span> <span class="n">fontWithName:familyName</span> <span class="n">size:</span><span class="mf">23.0f</span><span class="p">];</span>
    <span class="n-ProjectClass">C4Label</span> <span class="o">*</span><span class="n">l</span> <span class="o">=</span> <span class="p">[</span><span class="n-ProjectClass">C4Label</span> <span class="n">labelWithText:familyName</span> <span class="n">font:f</span><span class="p">];</span>
    ...
    <span class="k">if</span> <span class="p">(</span><span class="n">point</span><span class="py">.y</span> <span class="o">&gt;</span> <span class="k">self</span><span class="py">.canvas.height</span><span class="p">)</span> <span class="n">point</span> <span class="o">=</span> <span class="nc">CGPointMake</span><span class="p">(</span><span class="k">self</span><span class="py">.canvas.center.x</span><span class="o">+</span><span class="mi">10</span><span class="p">,</span> <span class="mi">10</span><span class="p">);</span>
